...
-- ========================================
-- This script initializes a fresh database with all necessary tables and sample data
-- including products, variants, promotions, orders, and more.
-- 
-- Usage: Run this script on a newly created empty PostgreSQL database
-- ========================================
...
-- 2. USERS
-- ========================================
-- Password: Use bcrypt hashed passwords in production
-- Example: $2a$10$wT5f...hashed represents hashed password
...
INSERT INTO suppliers (name, contact_person, email, phone, address, status, created_at, updated_at)
SELECT 'Fashion Forward Inc', 'Bob Jones', 'bob@fashionforward.com', '+987654321', '456 Style Ave, New York', 'ACTIVE', NOW(), NOW()
...
-- Total tables populated: 12
-- - Roles, Users, Suppliers, Brands, Categories
-- - Products (25 items)
-- - Product Variants (15 variants)
-- - Promotions (6 promotions)
-- - Banners (4 banners)
-- - Stock Transactions, Orders, Order Items
-- ========================================
